...
connectionsInpToHid = json_load["nn_after"]["architecture"]["inpToHidConnections"]
labels = json_load["nn_after"]["architecture"]["inpLayer"]

# Create a directed graph
G = nx.DiGraph()

for connection in connectionsInpToHid:
...
# min and max weights
weights = [connection["weight"] for connection in connectionsInpToHid]
